...
% specify which outputs to hold constant,需要维持的不是攻角而是下滑角，攻角可以自由变化
iy = [1,3];
...
% initial conditions
% MAV.pn0    = 0;%0;           % initial North position
% MAV.pe0    = 0;%0;           % initial East position
% MAV.pd0    = -650;%-600;        % initial Down position (negative altitude) 高度会影响飞行模式，要谨慎选取初值
